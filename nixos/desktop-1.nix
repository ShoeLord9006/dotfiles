...

{
  ...
  users.users.hannah = {
    isNormalUser = true;
    extraGroups = [ "wheel" "systemd-journal" "networkmanager" "video" ];# "hannah" "_saadarr" "qbittorrent" "delanria" ]; # hannah _saadarr qbittorrent delanria are all part of storage.daz.cat
    ###### NFS Compatability with storage.daz.cat
    uid = 13000;
    extraGroups += [ "hannah" "delanria" ]
    ######
